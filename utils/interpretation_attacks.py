...
class InterpretationAttacker():
    ...
    def set_interpretation_generator(self, method='simple_gradient'):
    ...
    def find_perturbation(self, sample, attack_method, invert):
    ...
    def iterative_attack(self, sample, attack_method, alpha=1., num_iters=100, invert=False):
        """Performs the desired attack method for the desired number of iterations.
        """
        for i in range(num_iters):
            perturbation = self.find_perturbation(sample, attack_method, invert)
